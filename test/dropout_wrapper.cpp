...
namespace neu_test {
	decltype(auto) dropout_wrapper_test() {
		...
		auto dropout_train_kernel =
			neu::make_kernel(neu::dropout_train_kernel_source, "dropout_train");
		auto dropout_test_kernel =
			neu::make_kernel(neu::dropout_test_kernel_source, "dropout_test");
